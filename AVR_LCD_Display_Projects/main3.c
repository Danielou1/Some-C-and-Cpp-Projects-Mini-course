 ...
 * Der restliche Bereich der Zeilen wird mit "0" gefüllt.
 *
...
/**
 * @brief Führt eine "Ping-Pong"-Animation auf dem LCD-Bildschirm aus.
 *
 * @details
 ...
 * Die Animation läuft endlos.
 *
 * @note Der Bildschirm wird bei jedem Zeilenwechsel gelöscht.
 */
void ping_pong() {
